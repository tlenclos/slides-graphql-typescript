...
<img src="assets/typescript.png" style={{ width: "80% "}} />
...
<TwitterTweetEmbed tweetId={"1153628808152592384"} />

Peut ralentir voir devenir bloquant.
...
```ts
const veryComplexStuffAndImDoneForToday: any = await fetch(url);
```
...
[premieroctet.com/jobs](https://www.premieroctet.com/jobs)
